...
namespace TaxiFarePredictionML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\pc\Documents\TaxiFarePredictionData.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\pc\AppData\Local\Temp\MLVSTools\TaxiFarePredictionML\TaxiFarePredictionML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options() { NumberOfLeaves = 75, MinimumExampleCountPerLeaf = 1, NumberOfTrees = 500, LearningRate = 0.02963793f, Shrinkage = 0.3304227f, LabelColumnName = "fare_amount", FeatureColumnName = "Features" });
